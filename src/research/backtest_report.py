...
<svg viewBox="0 0 {w} {h}" width="100%" preserveAspectRatio="none" class="equity">
  ...
  <polyline points="{poly}" fill="none" stroke="#10b981" stroke-width="2"
...
<style>
  :root {{
    --bg:#0a0e17; --surface:rgba(255,255,255,.04); --border:#1e293b;
    --text:#e2e8f0; --muted:#94a3b8; --pos:#10b981; --neg:#ef4444; --accent:#38bdf8;
  }}
  * {{ box-sizing:border-box; }}
  body {{ margin:0; background:radial-gradient(1200px 600px at 80% -10%, #11203a 0%, var(--bg) 55%);
         color:var(--text); font-family:-apple-system,"PingFang SC","Segoe UI",Inter,Roboto,sans-serif;
  ...
  .chart-box {{ background:var(--surface); border:1px solid var(--border); border-radius:16px; padding:16px; }}
